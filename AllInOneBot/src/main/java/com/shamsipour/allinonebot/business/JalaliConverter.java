...
public class JalaliConverter {
	...
	public long getTimeMillis() {
		...
		return ((this.days - DEF_NUMBER) * ONE_DAY_MS) + (hourMinuteSecond[0] * ONE_HOUR_MS)
				+ (hourMinuteSecond[1] * ONE_MINUTE_MS) + (hourMinuteSecond[2] * ONE_SECOND_MS);
	}
	...
	public String getShamsi() {
		return " تاریخ : " + getYear() + "/" + getMonth() + "/" + getDay();
	}
}
